    ...
    if menu == "4":
        ...
        while True:
            ...
            if menu == "1":
                ...
                print(colored(
                    "Search a car and get the specs and prices.\n", 'cyan'))
                car_model = input(
                    "Type a brand and model, like BMW Z4:\n").upper()
                ...
                if not new_data:
                    ...
                    resposta = input(
                        colored(
                            "Would you like to try another model? Y/N?\n",
                            'magenta'))
                ...
                while True:
                    ...
                    new_car()
                    resposta = input(
                        "Would you like a new register? Y/N?\n").upper()
                ...
                while True:
                    ...
                    values = data[1:]
                    car_model = input(
                        "Type a brand and model, such as BMW Z4:\n").upper()
                    achou = delete_data(car_model)
                    if achou is False:
                        print(colored("Car not found", 'red'))
                        resposta = input(
                            "1 - Delete another car\n"
                            "2 - Back to menu\n"
